...
--
-- Table structure for table `caballos`
--
...
--
-- Dumping data for table `caballos`
--

LOCK TABLES `caballos` WRITE;
/*!40000 ALTER TABLE `caballos` DISABLE KEYS */;
/*!40000 ALTER TABLE `caballos` ENABLE KEYS */;
UNLOCK TABLES;
